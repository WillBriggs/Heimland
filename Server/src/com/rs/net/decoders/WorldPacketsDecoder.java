...
public final class WorldPacketsDecoder extends Decoder {
	...
	public final static int GRAND_EXCHANGE_ITEM_SELECT = 71;
	...
	public static void decodeLogicPacket(final Player player, LogicPacket packet) {
		...
		if (packetId == WALKING_PACKET || packetId == MINI_WALKING_PACKET) {
		    ...
		    player.getPackets().sendIComponentText(1314, 91, ""+other.getDisplayName() +" Current Stats");
		    player.getPackets().sendIComponentText(1314, 90, "You Are Viewing a Players Current Stats.");
		    ...
		    player.getPackets().sendIComponentText(1314, 30, "Dominion Tower KC:"); //boss
