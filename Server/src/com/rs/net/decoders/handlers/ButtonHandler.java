...
public class ButtonHandler {
	...
	public static void handleButtons(final Player player, InputStream stream,
		...
		if (interfaceId == 1253) {
			...
			player.getPackets().sendOpenURL("http://citellumrsps.info/");
		...
		case 2://player rankings
			...
			player.getPackets().sendIComponentText(1245, 13, "<col=FF0000><u><shad=000000>Player Rankings<shad><u><col>");
			player.getPackets().sendIComponentText(1245, 14, "<img=1>ArcaneStream - Programmer and The Owner<img=1>");
			player.getPackets().sendIComponentText(1245, 15, "<img=1>Kye - Programmer and The Owner<img=1>");
			player.getPackets().sendIComponentText(1245, 16, "<img=1>Phoenix - Programmer and The Owner<img=1>");
			player.getPackets().sendIComponentText(1245, 17, "");
			player.getPackets().sendIComponentText(1245, 18, "<img=0>Jari - Global Moderator<img=0>");
			player.getPackets().sendIComponentText(1245, 19, "");
			player.getPackets().sendIComponentText(1245, 20, "<img=10>Aaron - Forum Moderator<img=10>");
		...
		case 4://Teleports
			...
			break;
		case 6://Minigames
			player.getDialogueManager().startDialogue("Minigames");
			break;
		case 8://Bossing
			player.getDialogueManager().startDialogue("Bossing");
			break;
		case 10://Pking
			player.getDialogueManager().startDialogue("pk");
			break;
		case 12://Monster
			player.getDialogueManager().startDialogue("Monster");
			break;
		case 14://skilling
			player.getDialogueManager().startDialogue("Options");
			break;
		}
			...
			boolean isBuying = (boolean) player.getTemporaryAttributtes().get("shop_buying") == true;
		...
		if (player.getRights() == 2)
			player.sm("InterfaceId " + interfaceId
