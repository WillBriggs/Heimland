...
import com.rs.game.player.dialogues.SandwichLady;
		...
		player.setCoordsEvent(new CoordsEvent(object, new Runnable() {
			...
			public void run() {
				...
				if (id == 47237) {
					...
					player.setNextWorldTile(new WorldTile(1339, 6380, 0));
				else if (id == 70799) {
				...
				if (id == 25014) {
					...
					player.sm("You have returned in to city of Zanaris.");
					player.getInventory().refresh();
						}
				if (id == 29395) {
			...
			public void run() {
				...
				boolean THIEVING_SUCCESS = false;// Eigenlijk moet dit false
					...
					if (player.getSkills().getLevel(Skills.THIEVING) >= 1) {
						...
						player.getInventory().addItem(995, 6528);
					...
					if (player.getSkills().getLevel(Skills.THIEVING) >= 50) {
						THIEVING_SUCCESS = true;
						player.getInventory().addItem(995, 9528);
					...
					if (player.getSkills().getLevel(Skills.THIEVING) >= 75) {
						THIEVING_SUCCESS = true;
						player.getInventory().addItem(995, 16528);
					...
					if (player.getSkills().getLevel(Skills.THIEVING) >= 85) {
						THIEVING_SUCCESS = true;
						player.getInventory().addItem(995, 20528);
