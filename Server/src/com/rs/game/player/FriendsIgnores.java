...
public class FriendsIgnores implements Serializable {
	...
	public void sendMessage(Player p2, String message) {
		...
		p2.getPackets().receivePrivateMessage(Utils.formatPlayerNameForDisplay(player.getUsername()), player.getDisplayName(), player.getMessageIcon(), message);
	}
	...
	public void sendQuickChatMessage(Player p2, QuickChatMessage quickChatMessage) {
		...
		p2.getPackets().receivePrivateChatQuickMessage(Utils.formatPlayerNameForDisplay(player.getUsername()), player.getDisplayName(), player.getMessageIcon(), quickChatMessage);
