...
public class NomadThrone extends Dialogue {
	...
	public void start() {
		...
		sendNPCDialogue(
				npcId,
				9785,
				player.getQuestManager().getQuestStage(Quests.NOMADS_REQUIEM) != 2 ? "The assassin aproaches, but I wonder what compels you to seek death."
	...
	public void run(int interfaceId, int componentId) {
		switch (stage) {
		case -1:
			stage = (byte) (player.getQuestManager().getQuestStage(
					Quests.NOMADS_REQUIEM) != 2 ? 2 : 0);
			sendNPCDialogue(
					npcId,
					9785,
		...
		case 4:
			...
			sendNPCDialogue(npcId, 9785,
					"Come then, tell me why you are really here.");
			break;
		case 5:
			stage = -2;
			sendPlayerDialogue(9827, "To...defeat...you!");
