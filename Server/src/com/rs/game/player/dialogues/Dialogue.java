	...
	public boolean sendOptionsDialogue(String title, String... options) {
		...
		for (int line = 0; line < 5; line++) {
			if (line < options.length) {
				if (line == 0)
					player.getPackets().sendIComponentText(1188, 3,
							options[line]);
				else if (line == 1)
					player.getPackets().sendIComponentText(1188, 24,
							options[line]);
				else if (line == 2)
					player.getPackets().sendIComponentText(1188, 29,
							options[line]);
				else if (line == 3)
					player.getPackets().sendIComponentText(1188, 34,
							options[line]);
				else if (line == 4)
					player.getPackets().sendIComponentText(1188, 39,
							options[line]);
			} else {
				if (line == 2) {
