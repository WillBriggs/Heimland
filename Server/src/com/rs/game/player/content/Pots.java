...
public final class Pots {
	...
	public static enum Pot {
		...
		MAGIC_FLASK(new int[] { 23423, 23425, 23427, 23429, 23431, 23433 },
				Effects.MAGIC_POTION), ANTI_POISION(new int[] { 2446, 175, 177,
				179 }, Effects.ANTIPOISON),
		...
		SUMMONING_POTION(new int[] { 12140, 12142, 12144, 12146 },
				Effects.SUMMONING_POT), HUNTER_POTION(new int[] { 9998, 10000,
				10002, 10004 }, Effects.HUNTER_POTION),
		...
		SANFEW_SERUM(new int[] { 10925, 10927, 10929, 10931 },
				Effects.SANFEW_SERUM),

		PRAYER_RENEWAL(new int[] { 21630, 21632, 21634, 21636 },
		...
		/*
		 * JUJU_MINING_FLASK(new int[] { 23131, 23132, 23133, 23134, 23135,
		 * 23136 }, null),
		 * 
		 * JUJU_COOKING_FLASK(new int[] { 23137, 23138, 23139, 23140, 23141,
		 * 23142 }, null),
		 * 
		 * JUJU_FARMING_FLASK(new int[] { 23143, 23144, 23145, 23146, 23147,
		 * 23148 }, null),
		 * 
		 * JUJU_WOODCUTTING_FLASK(new int[] { 23149, 23150, 23151, 23152, 23153,
		 * 23154 }, null),
		 * 
		 * JUJU_FISHING_FLASK(new int[] { 23155, 23156, 23157, 23158, 23159,
		 * 23160 }, null),
		 * 
		 * JUJU_HUNTER_FLASK(new int[] { 23161, 23162, 23163, 23164, 23165,
		 * 23166 }, null),
		 * 
		 * SCENTLESS_FLASK(new int[] { 23167, 23168, 23169, 23170, 23171, 23172
		 * }, null),
		 * 
		 * SARADOMINS_BLESSING_FLASK(new int[] { 23173, 23174, 23175, 23176,
		 * 23177, 23178 }, null),
		 * 
		 * GUTHIXS_GIFT_FLASK(new int[] { 23179, 23180, 23181, 23182, 23183,
		 * 23184 }, null),
		 * 
		 * ZAMORAKS_FAVOUR_FLASK(new int[] { 23185, 23186, 23187, 23188, 23189,
		 * 23190 }, null),
		 */
		...
		/*
		 * ZAMORAK_BREW_FLASK(new int[] { 23339, 23341, 23343, 23345, 23347,
		 * 23349 }, null),
		 */
		...
		/*
		 * RELICYMS_BALM_FLASK(new int[] { 23537, 23539, 23541, 23543, 23545,
		 * 23547 }, null),
		 * 
		 * SERUM_207_FLASK(new int[] { 23549, 23550, 23551, 23552, 23553, 23554
		 * }, null),
		 * 
		 * GUTHIX_BALANCE_FLASK(new int[] { 23555, 23557, 23559, 23561, 23563,
		 * 23565 }, null),
		 */
		 ...
		 * 23589 }, null),
		 * 
		 * ANTIPOISON_PLUS_PLUS_FLASK(new int[] { 23591, 23593, 23595, 23597,
		 * 23599, 23601 }, null),
		 * 
		 * SERUM_208_FLASK(new int[] { 23603, 23604, 23605, 23606, 23607, 23608
		 * }, null)
		 * 
		 * /*MAGIC_ESSENCE_FLASK(new int[] { 23633, 23634, 23635, 23636, 23637,
		 * 23638 }, null)
		 */;
		...
		SUMMONING_POT(Skills.SUMMONING) {
			...
			public int getAffectedSkill(Player player, int skillId,
				...
				int restore = (int) (Math.floor(player.getSkills()
						.getLevelForXp(Skills.SUMMONING) * 0.25) + 7);
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						if (!stop) {
							player.getPackets()
									.sendGameMessage(
											"<col=480000>Your antifire potion is about to run out...</col>");
							stop = true;
						} else {
							stop();
							player.getPackets()
									.sendGameMessage(
											"<col=480000>Your antifire potion has ran out...</col>");
						}
					}
				}, 500, 100);
			}
		...
		player.getPackets()
				.sendGameMessage(
						dosesLeft == 0 ? "You have finished your "
								+ (name.contains("flask") ? "flask and the glass shatters to peices."
										: "potion.")
								: "You have " + dosesLeft
