...
public class InterfaceManager {
	...
	public void sendMsPortal() {
		...
		player.getPackets().sendIComponentText(506, 0,  "Global Locations");
		player.getPackets().sendIComponentText(506, 4, "Monster Teleports");
		player.getPackets().sendIComponentText(506, 6, "Minigames Teleports");
		player.getPackets().sendIComponentText(506, 8, "Bossing Teleports");
		player.getPackets().sendIComponentText(506, 10, "Player Killing");
		player.getPackets().sendIComponentText(506, 12, "Dungeons");
		player.getPackets().sendIComponentText(506, 14, "Skilling Locations");
