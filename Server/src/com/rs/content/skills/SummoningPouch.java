...
public enum SummoningPouch {
	 ...
	 */
	SPIRIT_MOSQUITO_POUCH(12778, 17, 46.5, 7331, 0.5, 2, new Item(12158),
			new Item(12155), new Item(6319), new Item(12183, 1)),

	/**
	 * Represents a desrrt wyrm pouch.
	 */
	DESERT_WYRM_POUCH(12049, 18, 31.2, 6831, 0.4, 1, new Item(12159), new Item(
			12155), new Item(1783), new Item(12183, 45)),

	/**
	 * Represents a spirit scorpion pouch.
	 */
	SPIRIT_SCORPION_POUCH(12055, 19, 83.2, 6837, 0.9, 2, new Item(12160),
	 ...
	 */
	ALBINO_RAT_POUCH(12067, 23, 202.4, 6847, 2.3, 1, new Item(12163), new Item(
	...
	SPIRIT_DAGANNOTH_POUCH(12017, 83, 364.8, 6804, 4.1, 9, new Item(12160),
			new Item(6155), new Item(12115), new Item(12183, 1)),
	...
	WOLPERTINGER_POUCH(12089, 92, 404.8, 6869, 4.5, 10, new Item(12160),
			new Item(2859), new Item(3226), new Item(12115), new Item(12183,
					203)),
	 ...
	 *            The pouch item id.
	 * @param levelRequired
	 *            The level required to create.
	 * @param createExperience
	 *            The experience gained when creating a pouch.
	 * @param npcId
	 *            The familiar's NPC id.
	 * @param summonExperience
	 *            The experience gained when summoning.
	 * @param summonCost
	 *            The amount of summoning points to drain when summoned.
	 * @param items
	 *            The items required to create this pouch.
	 */
