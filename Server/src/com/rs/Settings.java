...
public final class Settings {
	 ...
	 */
	public static final String SERVER_NAME = "Heimland";
	public static final int PORT_ID = 43594;
	public static final String LASTEST_UPDATE = "<col=7E2217>Latest update: Server Version 0.0.1a";
	public static final String CACHE_PATH = "C:/Heimland Cache/cache/";
	public static final int RECEIVE_DATA_LIMIT = 7500;
	public static final int PACKET_SIZE_LIMIT = 7500;
	public static final int CLIENT_BUILD = 718;
	public static final int CUSTOM_CLIENT_BUILD = 5;
	public static boolean GUI;
        
        public static final String[] OWNERS = {"will","arix"};
	
	//Player Rights
		public static final int IS_OWNER = 7;
		public static final int IS_CO_OWNER = 6;
	 ...
	 * Link settings
	 */
	public static final String WEBSITE_LINK = "http://heimland.co.uk/";
	public static final String ITEMLIST_LINK = "http://item-hq.com/";
	public static final String ITEMDB_LINK = "http://item-hq.com/";
	 ...
	 */
	public static final String GUI_SIGN = "Heimland GUI";
	...
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(3221, 3219, 0); //I think it's this
	public static final String START_CONTROLER = "*"; // "NewHomeControler";//
	public static final WorldTile RESPAWN_PLAYER_LOCATION = new WorldTile(3221, 3219, 0); //new WorldTile(2966, 3387, 0);// //
	public static final long MAX_PACKETS_DECODER_PING_DELAY = 30000; // 30seconds
	public static final int MAX_STARTER_AMOUNT = 1;
	public static final int XP_RATE = 10;
